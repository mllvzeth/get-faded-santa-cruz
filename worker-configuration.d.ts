/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0c6087678839a3ad37baa877f7f68feb)
// Runtime types generated with workerd@1.20260317.1 2026-03-24 nodejs_compat_v2
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/_worker.js/index");
	}
	interface ProductionEnv {
		SESSION_STAGING: KVNamespace;
		ASSETS: Fetcher;
	}
	interface StagingEnv {
		SESSION_PRODUCTION: KVNamespace;
		ASSETS: Fetcher;
	}
	interface Env {
		SESSION_STAGING?: KVNamespace;
